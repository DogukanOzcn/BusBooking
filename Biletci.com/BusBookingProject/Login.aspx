                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:TextBox runat="server" placeholder="Kullanıcı Adı Gir" ID="txtUserId" CssClass="form-control" />
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:TextBox runat="server" ID="txtPassword" placeholder="Şifrenizi Girin" TextMode="Password" CssClass="form-control" />
                            ...
                            <div  class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <asp:Button runat="server" ID="btnLogin" Text="Giriş Yap" CssClass="btn btn-success" style="width:auto;"   ValidationGroup="vgLogin" CausesValidation="True" OnClick="btnLogin_Click" /><br /><br />
                                    <a href="UserRegistration.aspx">Kayıt Ol</a>
                                </div>
                            </div>
                        </div>
                    </div>
