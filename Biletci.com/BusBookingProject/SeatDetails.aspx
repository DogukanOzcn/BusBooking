...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:8%">
         <div class="panel-heading">
                    <div class="col-lg-8">
                        <h4 style="color: black;">Aşağıdaki düzende ilgili koltuğu tıklayarak koltuk seçin:</h4>
                    </div>
                    <div class="col-lg-2"><a id="hrefBackUrl" runat="server" class="btn btn-success" href="http://localhost:1778/Home.aspx" style="padding: 5px;" title="Back To Search List"><i class="fa fa-backward"></i>&nbsp;Arama Ekranına Dön</a></div>
                </div>
                <br />
                <div class="panel-body">
                    <div class="col-lg-8">
                        <table runat="server">
                            <tr>
                                <td style="color:black;font-size:large">BATI</td>
                                ...
                                <td style="color:black;font-size:large">DOĞU&nbsp;</td>
                            </tr>
                        </table>
                    ...
                    <div class="col-lg-4" style="overflow:auto">
                        ...
                        <asp:Label ID="lbldate" runat="server" Font-Bold="true"></asp:Label><br />
                                ...
                                <div style="margin-top: 5%" class="col-lg-12">
                                    <asp:Label ID="lblBoardingPoint" runat="server" Font-Bold="true" Text="Biniş Yerleri"></asp:Label>
                                    ...
                                    <asp:DropDownList ID="ddlDroppingpoints" runat="server" Style="display: none; width: 70%">
                                        <asp:ListItem Value="0" Text="Biniş Yeri Ekle"></asp:ListItem>
                                    </asp:DropDownList><br />
                                    <br />
                                    <asp:Button ID="btnPayment" runat="server" Text="Ödeme Yap" CssClass="btn btn-danger" OnClick="btnPayment_Click" ClientIDMode="Static" />
                                </div>
                            </div>
                        </div>
                    </div>
